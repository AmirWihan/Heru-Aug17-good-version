    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-muted/40 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                <Card className="text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <Link href="/login?role=client" passHref className="p-8 h-full flex flex-col">
                 ...
                 <Card className="text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <Link href="/login?role=lawyer" passHref className="p-8 h-full flex flex-col">
                        <CardHeader className="flex-1">
